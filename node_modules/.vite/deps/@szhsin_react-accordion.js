...
var AccordionProvider = (props) => (0, import_jsx_runtime.jsx)(AccordionContext.Provider, _extends({}, props));
...
var _excluded2 = ["providerValue", "className"];
var ControlledAccordion = (0, import_react4.forwardRef)((_ref, ref) => {
  let {
    providerValue,
    className
  ...
  return (0, import_jsx_runtime2.jsx)(AccordionProvider, {
    value: providerValue,
    children: (0, import_jsx_runtime2.jsx)("div", _extends({}, mergeProps(accordionProps, rest), {
      ref,
...
var _excluded3 = ["allowMultiple", "initialEntered", "mountOnEnter", "unmountOnExit", "transition", "transitionTimeout", "onStateChange"];
var Accordion = (0, import_react5.forwardRef)((_ref, ref) => {
  let {
    allowMultiple,
    initialEntered,
    mountOnEnter,
  ...
  return (0, import_jsx_runtime3.jsx)(ControlledAccordion, _extends({}, rest, {
    ref,
    providerValue
  }));
});
...
var _excluded4 = ["itemKey", "initialEntered"];
var withAccordionItem = (WrappedItem2) => {
  const WithAccordionItem = (0, import_react12.forwardRef)((_ref, ref) => {
    let {
      itemKey,
      initialEntered
    } = _ref, rest = _objectWithoutPropertiesLoose(_ref, _excluded4);
    return (0, import_jsx_runtime4.jsx)(WrappedItem2, _extends({
      forwardedRef: ref
...
var _excluded5 = ["forwardedRef", "itemRef", "state", "toggle", "className", "disabled", "header", "headingTag", "headingProps", "buttonProps", "contentProps", "panelProps", "children"];
var getRenderNode = (nodeOrFunc, props) => typeof nodeOrFunc === "function" ? nodeOrFunc(props) : nodeOrFunc;
var WrappedItem = (0, import_react13.memo)((_ref) => {
  let {
    forwardedRef,
    itemRef,
    state,
  ...
  return (0, import_jsx_runtime5.jsxs)("div", _extends({}, rest, {
    ...
    children: [(0, import_jsx_runtime5.jsx)(Heading, _extends({}, headingProps, {
      ...
      children: (0, import_jsx_runtime5.jsx)("div", _extends({}, mergeProps(_panelProps, panelProps), {
        ref: panelRef,
